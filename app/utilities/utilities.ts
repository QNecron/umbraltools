...
export const Attack = (
  ...
  if (
    ...
    attribute = dex;
  else if (weapon_properties === "Ps" || weapon_properties === "Ps, Th")
    attribute = chr;
  else attribute = str;
...
export const Damage = (
  ...
  Object.entries(data).map(
    ([key, value]) => (
      ...
      value === "Corroded Vambraces" && isRanged === false
        ? (damageBonus += " + 1 (Acid)")
        : "",
      value === "Forgemaster's Gloves" && isRanged === false
        ? (damageBonus += " + 1 (Fire)")
        : "",
      ...
      value === "Mantle of Wreathing Flame"
        ? (damageBonus += " + 1d4 (Fire)")
        : "",
      value === "Cloak of Minor Missiles" && isRanged === true
        ? (damageBonus += " + 1")
        : "",
      value === "Stormturner Cloak"
        ? (damageBonus += " + 1d4 (Electrical)")
        : "",
...
export const Spellcasting = (
  ...
  Object.entries(talents).map(
    ([key, value]) => (
      value === "+1 to priest spellcasting checks" ? (bonus += 1) : 0,
      value === "+2 to Intelligence stat or +1 to wizard spellcasting checks" &&
      attribute >= 18
        ? (bonus += 1)
        : 0,
      value === "+2 to Charisma stat or +1 to witch spellcasting checks" &&
      attribute >= 18
        ? (bonus += 1)
        : 0,
  ...
  modifier = Modifier(
    attribute.toString(),
    tempAttribute.toString(),
    augAttribute.toString()
  );
...
// load file
export const LoadFile = (file: Blob) =>
