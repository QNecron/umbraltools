...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Custom magic items for Umbral Tools games.",
    },
  ];
};
      ...
      <Section padding="bottom">
        <Wrapper>
          <nav className="filters" aria-label="Item filters" role="navigation">
            ...
            >
              <Tabs data={ItemType} state={base} update={baseUpdate}>
                <h3 className="tabs__title" heading="5">
                  Type
                </h3>
              </Tabs>
          ...
          <Grid>
            {ItemsData.sort((a, b) => (a.name < b.name ? -1 : 1)).map(
              (item, index) => {
                ...
                let ItemAdditional = (
                  <>
                    <strong>Additional.</strong> {item.additional}
                  </>
                );
                ...
                return (
                  <Card
                    ...
                    copy2={!item.bonus ? null : ItemBonus}
                    copy3={!item.benefit ? null : ItemBenefit}
