...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Character creator for Umbral Tools games.",
    },
  ];
};
...
export default function Creator() {
  ...
  const EquipmentDataFull = [
    "hands_primary",
    "hands_secondary",
    "armor",
    "shield",
  ].concat(EquipmentData);
      ...
      <Wrapper>
        ...
        >
          ...
          >
            ...
            {EquipmentDataFull.map((item, index) => {
              function MatchProp(prop: string) {
                if (prop == "hands_primary")
                  return character.equipment.hands_primary;
                else if (prop == "hands_secondary")
                  return character.equipment.hands_secondary;
                  ...
                  return character.equipment.accessory;
              ...
              let itemBase = ItemInformation(
                MatchData(item),
                MatchProp(item),
                "base"
              );
              let itemDescription = ItemInformation(
                MatchData(item),
                MatchProp(item),
                "description"
              );
              let itemBenefit = ItemInformation(
                MatchData(item),
                MatchProp(item),
                "benefit"
              );
              let itemAdditional = ItemInformation(
                MatchData(item),
                MatchProp(item),
                "additional"
              );
                ...
                <Fragment key={index}>
                  {MatchProp(item) && (
                    <Accordion
                      ...
                      button="full primary"
                    >
                      {itemBase.includes("undefined") === true ? null : (
                        <p>
                          <em>{itemBase}</em>
                        </p>
                      )}
            ...
            <div className="block block__wrap">
              {TemporaryData.map((bonus, index) => {
                function Temp(prop: string) {
                  if (prop == "hit_points")
                    return character.temporary.hit_points;
                    ...
                    return character.temporary.spellcheck;
          ...
          >
                    ...
                    <div className="block">
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (
                            Object.hasOwn(data, "augments") &&
                            typeof data["augments"] === "object" &&
                            data["augments"] !== null
                          ) {
                      ...
                      {character.name === name && (
                        <button
                          ...
                          button="icon primary"
                          onClick={() =>
                            CharacterSave(character.name, character)
                          }
                        >
            ...
            >
              <p>
                Downloading character added (as JSON), must load character
                first.
              </p>
              <p>Uploading character added, still in testing.</p>
              <p>
                Some talents accounted for in stats (ATK, AC, etc), but not all
                - yet.
              </p>
            </Accordion>
        ...
        <Grid gap={32} desktop={2} tablet={2}>
          <div className="grid__column">
            ...
            <Section padding="creator" title="Class">
              <div className="block">
                <div className="block__item">{HitDie(character.class)}</div>
                <Input
                  type="select"
                  id="class"
                  label="Class"
                ...
                <div className="block__item">
                  {Total(
                    Modifier(
                      ...
                      character.temporary.con,
                      character.augments.con
                    ),
                  ...
                  onClick={(e) =>
                    characterUpdate({
                      ...
                      hit_points: DiceRoll(
                        ...
                        parseInt(character.level)
                      ).toString(),
                    })
                  }
                >
                  <span className="srt">
                    Roll hit die times level to determine hit points
                  </span>
                  <Icons icon="dice" />
                </button>
              </div>
                  ...
                  >
                    ...
                    {ClassesData.map((role, index) => {
                      if (role.class === character.class) {
                        return (
                          <Fragment key={index}>
                            <option value={role.talents.talent_1}>
                              {role.talents.talent_1}
                            </option>
                            <option value={role.talents.talent_2}>
                              {role.talents.talent_2}
                            </option>
                            <option value={role.talents.talent_3}>
                              {role.talents.talent_3}
                            </option>
                            <option value={role.talents.talent_4}>
                              {role.talents.talent_4}
                            </option>
                            <option value={role.talents.talent_5}>
                              {role.talents.talent_5}
                            </option>
                          </Fragment>
                        );
                      }
              ...
              <Section padding="creator" title="Spells">
                <div className="block">
                  <Input
                    ...
                    change={(event: ChangeEvent<HTMLTextAreaElement>) =>
                      characterUpdate({
                        ...character,
          ...
          <div className="grid__column">
                ...
                <div className="block__item">
                  {ArmorClass(
                    ...
                    Modifier(
                      ...
                      character.temporary.dex,
                      character.augments.dex
                    ),
                ...
                <div className="block__item">
                  {Attack(
                    Modifier(
                      ...
                      character.temporary.str,
                      character.augments.str
                    ),
                    Modifier(
                      character.attributes.dex,
                      character.temporary.dex,
                    ...
                    Modifier(
                      character.attributes.chr,
                      character.temporary.chr,
                      character.augments.chr
                    ),
                    WeaponData,
              ...
              {IsSpecialized(character.class) && (
                <div className="block">
                  ...
                  <Input
                    ...
                    change={(event: ChangeEvent<HTMLSelectElement>) =>
                      characterClassAttackBonusAUpdate(
                        !characterClassAttackBonusA
                      )
                    }
                  />
              ...
              {IsSpecialized(character.class) && (
                <div className="block">
                  ...
                  <Input
                    ...
                    change={(event: ChangeEvent<HTMLSelectElement>) =>
                      characterClassAttackBonusBUpdate(
                        !characterClassAttackBonusB
                      )
                    }
                  />
            ...
            <Section padding="creator" title="Inventory">
              <div className="block">
                <div className="block__item" heading="5">
                  LT
                </div>
                <Input
                  type="number"
